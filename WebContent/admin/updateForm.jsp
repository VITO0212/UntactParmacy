...
<body>
	...
	<div class="container">
		...
		<br>
		<!-- Update Form  -->
		<form name="form" method="POST" action="<c:url value='/user/update/admin'/>">
			...
			<div class="form-group row">
				...
				<div class="form-group row">
				<label for="user_level" class="col-lg-2 col-form-label">사용자 등급</label>
				<div class="col-lg-10">
				...
				<div class="form-group">
					...
					<a href="<c:url value='/admin/list' />" class="btn btn-link">사용자 목록
				</a>
			</div>
		</form>
	</div>
