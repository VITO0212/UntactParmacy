...
<body>
	...
	<div class="container">
		...
		<form name="form" method="POST"
			...
			<div class="form-group row">
				...
				<div class="col-lg-10">
					<input type="text" name="user_id" class="form-control"
						placeholder="${curUserId}" value="${curUserId}" readonly>
			...
			<div class="form-group">
				<label for="med_id" class="col-lg-2 col-form-label">약 ID</label>
  ...
  <c:choose>
				...
				<c:otherwise>
				&nbsp;<input class="box" size="2" type="text" name="quantity" placeholder="1">	
				</c:otherwise>
			</c:choose>
					</div>
				</c:forEach>
